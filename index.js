...
console.log ("T1:", copy(originalFlavors))
...
console.log("T2:", is31Flavors(originalFlavors))
...
console.log("T3:", addFlavor(originalFlavors, "Rainbow Sherbert"))
...
console.log("T4:", removeLastFlavor(originalFlavors))
...
console.log("T5:", getFlavorByIndex(originalFlavors, 2))
...
console.log("T6:", removeFlavorByName(originalFlavors, "Vanilla"))
...
function filterByWord(array, string){
  for (let i = 0; i < array.length; i++){
    if  (array[i].includes(string)){
        return array.slice(i, i + 6)
        
    }
}
}
console.log("T7:", filterByWord(originalFlavors, "Sherbet"))
